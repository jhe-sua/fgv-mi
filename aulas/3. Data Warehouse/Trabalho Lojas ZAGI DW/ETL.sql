...
select 
	...
	cc.CreditoPraca
from
	CensoCliente cc full join Cliente c on c.ID = cc.IDCliente;
...
select
	...
	lt.DescricaoLayout
from
	Loja l full join Regiao r on r.RegiaoID=l.RegiaoID
...
INSERT INTO [DB197990112].[dbo].[Incluido_em] values(1, 2, 2);

insert into [DB197990112].[dbo].[Trans_de_Venda] values (6,GETDATE(),3,2);

INSERT INTO [DB197990112].[dbo].[Incluido_em] values(1, 2, 6);
INSERT INTO [DB197990112].[dbo].[Incluido_em] values(2, 1, 6);
